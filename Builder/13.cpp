...
int main(){
	...
	cout<<"---------------------------------------------------------------------------------"<<endl;
	cout<<"             Surjeetsinh Rathod"<<endl;
	cout<<""<<endl;
	cout<<""<<endl;
	cout<<""<<endl;
	cout<<"               -: Trainer :- "<<endl;
	cout<<"--------------------------------------------------------------------------------"<<endl;
	cout<<"                Dummy User"<<endl;
	cout<<""<<endl;
	...
	cout<<""<<endl;
	cout<<""<<endl;
	cout<<"Enter The Name Of Staff               :Chetan"<<endl;
	cout<<"Enter The Account Number Of Staff     :0707"<<endl;
	cout<<"Enter The Phone Number Of Staff       :9090223355"<<endl;
	cout<<"Enter The E-mail Of Staff             :abcdr111@gmail.com"<<endl;
	cout<<""<<endl;
	cout<<""<<endl;	
	cout<<""<<endl;
	cout<<"-----------------------------------------------------------------------------------"<<endl;	
	cout<<"Name                                   :Shreya"<<endl;
	cout<<"Account No                             :1010"<<endl;
	cout<<"Phone No                               :1122338899"<<endl;
	cout<<"E-mail                                 :ababab123@gmail.com"<<endl;
	cout<<"------------------------------------------------------------------------------------"<<endl;		
  	cout<<""<<endl;	
	cout<<""<<endl;
